...
\
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">\
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:border-indigo-300 transition-all flex flex-col">\
              ...
              <a\
                href="https://wa.me/6285255700081?text=Halo,%20saya%20tertarik%20dengan%20paket%20Personal%20aplikasi%20SATU%20GURU."\
                target="_blank"\
                rel="noopener noreferrer"\
                className="w-full py-3 px-4 bg-indigo-50 text-indigo-700 font-bold rounded-xl text-center hover:bg-indigo-100 transition-colors"\
              >\
                Hubungi Admin\
              </a>\
            </div>\
\
            ...
            <div className="bg-indigo-600 p-8 rounded-2xl border border-indigo-500 shadow-xl flex flex-col relative overflow-hidden">\
              ...
              <a\
                href="https://wa.me/6285255700081?text=Halo,%20saya%20tertarik%20dengan%20paket%20Sekolah%20aplikasi%20SATU%20GURU."\
                target="_blank"\
                rel="noopener noreferrer"\
                className="w-full py-3 px-4 bg-white text-indigo-600 font-bold rounded-xl text-center hover:bg-indigo-50 transition-colors shadow-lg shadow-indigo-900/20"\
              >\
...
INNER
sed -i -f insert_pricing.sed src/components/LandingPageView.tsx
